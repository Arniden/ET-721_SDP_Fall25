...
print("----- Example 7: return items, keys and values in a dictonary -----")
...
count_dict = {provider: 0 for provider in providers}

for user in users:
    for provider in providers:
        if f"@{provider}.com" in user.lower():
            count_dict[provider] += 1
